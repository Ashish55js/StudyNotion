...
export const AddCourseCategories = async (data, token) => {
  let result = null
  const toastId = toast.loading("Loading...")
  try {
    ...
    // console.log("ADD_CATEGORIES_API RESPONSE............", response)
    if (!response?.data?.success) {
...
export const fetchCategoryById = async (categoryId, token) => {
  ...
  try {
    const response = await apiConnector("POST", SINGLE_COURSE_CATEGORY_API, 
        {         
            categoryId,
            Authorization: `Bearer ${token}`,
        }
    )
    // console.log("SINGLE COURSE_CATEGORIES_API API RESPONSE............", response)
    if (!response?.data?.success) {
      throw new Error("Could Not Fetch Course Category by id")
    }
    result = response?.data?.data;
  } catch (error) {
    console.log("SINGLE COURSE_CATEGORY_API API ERROR............", error)
    toast.error(error.message)
  }
...
export const updateCategory = async (data, token) => {
  ...
  toast.dismiss(toastId)
  // console.log("res in update "+result);
  return result
}
...
export const getFullDetailsOfCourse = async (courseId, token) => {
  // const toastId = toast.loading("Loading...")
  //   dispatch(setLoading(true));
  // console.log("course id in courseDetailsAPI "+courseId);
  let result = null
  try {
    const response = await apiConnector(
      "POST",
